...
-- Horizontal layout for image + text container
local horizontalLayout = Instance.new("UIListLayout")
horizontalLayout.FillDirection = Enum.FillDirection.Horizontal
horizontalLayout.VerticalAlignment = Enum.VerticalAlignment.Center
horizontalLayout.Padding = UDim.new(0, 0) -- Space between image and text
horizontalLayout.Parent = titleFrame
...
textContainer.Size = UDim2.new(1, -42, 1, 0) -- Account for image width + padding
textContainer.AutomaticSize = Enum.AutomaticSize.Y -- Adjust height to content
textContainer.Parent = titleFrame
...
verticalLayout.Padding = UDim.new(0, 2) -- Small gap between title and subtitle
